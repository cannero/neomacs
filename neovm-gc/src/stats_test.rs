...
fn collection_stats_saturating_add_assign_accumulates_all_fields() {
    let mut total = CollectionStats {
        ...
        promoted_bytes: 6,
        nursery_bytes_before: 200,
        nursery_survivor_bytes: 50,
        mark_steps: 7,
        mark_rounds: 8,
        reclaimed_bytes: 9,
    ...
    let delta = CollectionStats {
        ...
        promoted_bytes: 60,
        nursery_bytes_before: 800,
        nursery_survivor_bytes: 150,
        mark_steps: 70,
        mark_rounds: 80,
        reclaimed_bytes: 90,
    ...
    assert_eq!(
        ...
        CollectionStats {
            ...
            promoted_bytes: 66,
            nursery_bytes_before: 1_000,
            nursery_survivor_bytes: 200,
            mark_steps: 77,
            mark_rounds: 88,
            reclaimed_bytes: 99,
...
fn collection_stats_completed_minor_cycle_tracks_reclaim_and_regions() {
    ...
    assert_eq!(
        ...
        CollectionStats {
            ...
            promoted_bytes: 9,
            nursery_bytes_before: 80,
            // 20 still in nursery + 9 promoted = 29 survived
            nursery_survivor_bytes: 29,
            mark_steps: 7,
            mark_rounds: 8,
            reclaimed_bytes: 40,
            finalized_objects: 0,
