...
**[Sponsor Neomacs](https://github.com/sponsors/eval-exec):** Neomacs is a long-term project that takes significant ongoing work to build, test, and maintain. If you want to support its development, please consider sponsoring it on GitHub Sponsors.
