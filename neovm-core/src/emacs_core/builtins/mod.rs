...
pub(crate) fn init_builtins(ctx: &mut super::eval::Context) {
    ...
    use super::value::*;
        ...
        ctx.defsubr("integer-or-marker-p", |_ctx, args| builtin_integer_or_marker_p(args), 0, None);
        ctx.defsubr("number-or-marker-p", |_ctx, args| builtin_number_or_marker_p(args), 0, None);
        ctx.defsubr("vector-or-char-table-p", |_ctx, args| builtin_vector_or_char_table_p(args), 0, None);
        ctx.defsubr("markerp", |_ctx, args| super::marker::builtin_markerp(args), 0, None);
        ctx.defsubr("marker-insertion-type", |_ctx, args| super::marker::builtin_marker_insertion_type(args), 0, None);
        ctx.defsubr("make-marker", |_ctx, args| super::marker::builtin_make_marker(args), 0, None);
        ctx.defsubr("bool-vector-p", |_ctx, args| super::chartable::builtin_bool_vector_p(args), 0, None);
        ctx.defsubr("make-category-set", |_ctx, args| super::category::builtin_make_category_set(args), 0, None);
        ctx.defsubr("function-equal", |_ctx, args| builtin_function_equal(args), 0, None);
        ctx.defsubr("module-function-p", |_ctx, args| builtin_module_function_p(args), 0, None);
        ctx.defsubr("user-ptrp", |_ctx, args| builtin_user_ptrp(args), 0, None);
        ctx.defsubr("symbol-with-pos-p", |_ctx, args| builtin_symbol_with_pos_p(args), 0, None);
        ctx.defsubr("symbol-with-pos-pos", |_ctx, args| builtin_symbol_with_pos_pos(args), 0, None);
        ...
        ctx.defsubr("substring-no-properties", |_ctx, args| builtin_substring_no_properties(args), 0, None);
        ...
        ctx.defsubr("make-string", |_ctx, args| builtin_make_string(args), 0, None);
        ctx.defsubr("string", |_ctx, args| builtin_string(args), 0, None);
        ctx.defsubr("string-width", |_ctx, args| builtin_string_width(args), 0, None);
        ...
        ctx.defsubr("secure-hash-algorithms", |_ctx, args| builtin_secure_hash_algorithms(args), 0, None);
        ctx.defsubr("prefix-numeric-value", |_ctx, args| builtin_prefix_numeric_value(args), 0, None);
        ctx.defsubr("propertize", |_ctx, args| builtin_propertize(args), 0, None);
        ctx.defsubr("bare-symbol", |_ctx, args| super::builtins_extra::builtin_bare_symbol(args), 0, None);
        ctx.defsubr("capitalize", |_ctx, args| super::casefiddle::builtin_capitalize(args), 0, None);
        ctx.defsubr("charsetp", |_ctx, args| super::charset::builtin_charsetp(args), 0, None);
        ctx.defsubr("charset-plist", |_ctx, args| super::charset::builtin_charset_plist(args), 0, None);
        ctx.defsubr("define-charset-internal", |_ctx, args| super::charset::builtin_define_charset_internal(args), 0, None);
        ctx.defsubr("define-charset-alias", |_ctx, args| super::charset::builtin_define_charset_alias(args), 0, None);
        ctx.defsubr("internal-lisp-face-p", |_ctx, args| super::font::builtin_internal_lisp_face_p(args), 0, None);
        ctx.defsubr("internal-make-lisp-face", |_ctx, args| super::font::builtin_internal_make_lisp_face(args), 0, None);
        ctx.defsubr("internal-set-lisp-face-attribute", |_ctx, args| super::font::builtin_internal_set_lisp_face_attribute(args), 0, None);
        ctx.defsubr("string-to-syntax", |_ctx, args| builtin_string_to_syntax(args), 0, None);
        ctx.defsubr("syntax-class-to-char", |_ctx, args| super::syntax::builtin_syntax_class_to_char(args), 0, None);
        ctx.defsubr("copy-syntax-table", |_ctx, args| super::syntax::builtin_copy_syntax_table(args), 0, None);
        ctx.defsubr("syntax-table-p", |_ctx, args| super::syntax::builtin_syntax_table_p(args), 0, None);
        ctx.defsubr("standard-syntax-table", |_ctx, args| super::syntax::builtin_standard_syntax_table(args), 0, None);
        ctx.defsubr("current-time", |_ctx, args| super::timefns::builtin_current_time(args), 0, None);
        ctx.defsubr("current-cpu-time", |_ctx, args| builtin_current_cpu_time(args), 0, None);
        ctx.defsubr("get-internal-run-time", |_ctx, args| builtin_get_internal_run_time(args), 0, None);
        ctx.defsubr("float-time", |_ctx, args| super::timefns::builtin_float_time(args), 0, None);
        ctx.defsubr("daemonp", |_ctx, args| builtin_daemonp(args), 0, None);
        ctx.defsubr("daemon-initialized", |_ctx, args| builtin_daemon_initialized(args), 0, None);
        ctx.defsubr("flush-standard-output", |_ctx, args| builtin_flush_standard_output(args), 0, None);
        ctx.defsubr("force-mode-line-update", |_ctx, args| builtin_force_mode_line_update(args), 0, None);
        ctx.defsubr("invocation-directory", |_ctx, args| builtin_invocation_directory(args), 0, None);
        ctx.defsubr("invocation-name", |_ctx, args| builtin_invocation_name(args), 0, None);
        ctx.defsubr("file-name-directory", |_ctx, args| super::fileio::builtin_file_name_directory(args), 0, None);
        ctx.defsubr("file-name-nondirectory", |_ctx, args| super::fileio::builtin_file_name_nondirectory(args), 0, None);
        ctx.defsubr("file-name-as-directory", |_ctx, args| super::fileio::builtin_file_name_as_directory(args), 0, None);
        ctx.defsubr("directory-file-name", |_ctx, args| super::fileio::builtin_directory_file_name(args), 0, None);
        ctx.defsubr("file-name-concat", |_ctx, args| super::fileio::builtin_file_name_concat(args), 0, None);
        ctx.defsubr("file-name-absolute-p", |_ctx, args| super::fileio::builtin_file_name_absolute_p(args), 0, None);
        ctx.defsubr("directory-name-p", |_ctx, args| super::fileio::builtin_directory_name_p(args), 0, None);
        ctx.defsubr("substitute-in-file-name", |_ctx, args| super::fileio::builtin_substitute_in_file_name(args), 0, None);
        ctx.defsubr("set-file-acl", |_ctx, args| super::fileio::builtin_set_file_acl(args), 0, None);
        ctx.defsubr("set-file-selinux-context", |_ctx, args| super::fileio::builtin_set_file_selinux_context(args), 0, None);
        ctx.defsubr("visited-file-modtime", |_ctx, args| super::fileio::builtin_visited_file_modtime(args), 0, None);
        ctx.defsubr("make-temp-name", |_ctx, args| super::fileio::builtin_make_temp_name(args), 0, None);
        ctx.defsubr("next-read-file-uses-dialog-p", |_ctx, args| super::fileio::builtin_next_read_file_uses_dialog_p(args), 0, None);
        ctx.defsubr("unhandled-file-name-directory", |_ctx, args| super::fileio::builtin_unhandled_file_name_directory(args), 0, None);
        ctx.defsubr("get-truename-buffer", |_ctx, args| super::fileio::builtin_get_truename_buffer(args), 0, None);
        ctx.defsubr("single-key-description", |_ctx, args| builtin_single_key_description(args), 0, None);
        ctx.defsubr("key-description", |_ctx, args| builtin_key_description(args), 0, None);
        ctx.defsubr("event-convert-list", |_ctx, args| builtin_event_convert_list(args), 0, None);
        ctx.defsubr("text-char-description", |_ctx, args| builtin_text_char_description(args), 0, None);
        ctx.defsubr("set-binary-mode", |_ctx, args| super::process::builtin_set_binary_mode(args), 0, None);
        ctx.defsubr("group-name", |_ctx, args| super::editfns::builtin_group_name(args), 0, None);
        ctx.defsubr("group-gid", |_ctx, args| super::editfns::builtin_group_gid(args), 0, None);
        ctx.defsubr("group-real-gid", |_ctx, args| super::editfns::builtin_group_real_gid(args), 0, None);
        ctx.defsubr("load-average", |_ctx, args| super::editfns::builtin_load_average(args), 0, None);
        ctx.defsubr("logcount", |_ctx, args| super::editfns::builtin_logcount(args), 0, None);
        ctx.defsubr("set-frame-size-and-position-pixelwise", |_ctx, args| builtin_set_frame_size_and_position_pixelwise(args), 0, None);
        ctx.defsubr("mouse-position-in-root-frame", |_ctx, args| builtin_mouse_position_in_root_frame(args), 0, None);
        ctx.defsubr("x-load-color-file", |_ctx, args| super::font::builtin_x_load_color_file(args), 0, None);
        ctx.defsubr("define-fringe-bitmap", |_ctx, args| builtin_define_fringe_bitmap(args), 0, None);
        ctx.defsubr("destroy-fringe-bitmap", |_ctx, args| builtin_destroy_fringe_bitmap(args), 0, None);
        ctx.defsubr("display--line-is-continued-p", |_ctx, args| builtin_display_line_is_continued_p(args), 0, None);
        ctx.defsubr("display--update-for-mouse-movement", |_ctx, args| builtin_display_update_for_mouse_movement(args), 0, None);
        ctx.defsubr("do-auto-save", |_ctx, args| builtin_do_auto_save(args), 0, None);
        ctx.defsubr("external-debugging-output", |_ctx, args| builtin_external_debugging_output(args), 0, None);
        ctx.defsubr("describe-buffer-bindings", |_ctx, args| builtin_describe_buffer_bindings(args), 0, None);
        ctx.defsubr("describe-vector", |_ctx, args| builtin_describe_vector(args), 0, None);
        ctx.defsubr("face-attributes-as-vector", |_ctx, args| builtin_face_attributes_as_vector(args), 0, None);
        ctx.defsubr("font-face-attributes", |_ctx, args| builtin_font_face_attributes(args), 0, None);
        ctx.defsubr("font-get-glyphs", |_ctx, args| builtin_font_get_glyphs(args), 0, None);
        ctx.defsubr("font-get-system-font", |_ctx, args| builtin_font_get_system_font(args), 0, None);
        ctx.defsubr("font-get-system-normal-font", |_ctx, args| builtin_font_get_system_normal_font(args), 0, None);
        ctx.defsubr("font-has-char-p", |_ctx, args| builtin_font_has_char_p(args), 0, None);
        ctx.defsubr("font-match-p", |_ctx, args| builtin_font_match_p(args), 0, None);
        ctx.defsubr("font-shape-gstring", |_ctx, args| builtin_font_shape_gstring(args), 0, None);
        ctx.defsubr("font-variation-glyphs", |_ctx, args| builtin_font_variation_glyphs(args), 0, None);
        ctx.defsubr("fontset-font", |_ctx, args| builtin_fontset_font(args), 0, None);
        ctx.defsubr("fontset-info", |_ctx, args| builtin_fontset_info(args), 0, None);
        ctx.defsubr("fontset-list", |_ctx, args| builtin_fontset_list(args), 0, None);
        ctx.defsubr("fontset-list-all", |_ctx, args| builtin_fontset_list_all(args), 0, None);
        ctx.defsubr("frame--set-was-invisible", |_ctx, args| builtin_frame_set_was_invisible(args), 0, None);
        ctx.defsubr("frame-after-make-frame", |_ctx, args| builtin_frame_after_make_frame(args), 0, None);
        ctx.defsubr("frame-ancestor-p", |_ctx, args| builtin_frame_ancestor_p(args), 0, None);
        ctx.defsubr("frame-bottom-divider-width", |_ctx, args| builtin_frame_bottom_divider_width(args), 0, None);
        ctx.defsubr("frame-child-frame-border-width", |_ctx, args| builtin_frame_child_frame_border_width(args), 0, None);
        ctx.defsubr("frame-focus", |_ctx, args| builtin_frame_focus(args), 0, None);
        ctx.defsubr("frame-font-cache", |_ctx, args| builtin_frame_font_cache(args), 0, None);
        ctx.defsubr("frame-fringe-width", |_ctx, args| builtin_frame_fringe_width(args), 0, None);
        ctx.defsubr("frame-internal-border-width", |_ctx, args| builtin_frame_internal_border_width(args), 0, None);
        ctx.defsubr("frame-or-buffer-changed-p", |_ctx, args| builtin_frame_or_buffer_changed_p(args), 0, None);
        ctx.defsubr("frame-parent", |_ctx, args| builtin_frame_parent(args), 0, None);
        ctx.defsubr("frame-pointer-visible-p", |_ctx, args| builtin_frame_pointer_visible_p(args), 0, None);
        ctx.defsubr("frame-right-divider-width", |_ctx, args| builtin_frame_right_divider_width(args), 0, None);
        ctx.defsubr("frame-scale-factor", |_ctx, args| builtin_frame_scale_factor(args), 0, None);
        ctx.defsubr("frame-scroll-bar-height", |_ctx, args| builtin_frame_scroll_bar_height(args), 0, None);
        ctx.defsubr("frame-scroll-bar-width", |_ctx, args| builtin_frame_scroll_bar_width(args), 0, None);
        ctx.defsubr("frame-window-state-change", |_ctx, args| builtin_frame_window_state_change(args), 0, None);
        ctx.defsubr("fringe-bitmaps-at-pos", |_ctx, args| builtin_fringe_bitmaps_at_pos(args), 0, None);
        ctx.defsubr("gap-position", |_ctx, args| builtin_gap_position(args), 0, None);
        ctx.defsubr("gap-size", |_ctx, args| builtin_gap_size(args), 0, None);
        ctx.defsubr("garbage-collect-heapsize", |_ctx, args| builtin_garbage_collect_heapsize(args), 0, None);
        ctx.defsubr("garbage-collect-maybe", |_ctx, args| builtin_garbage_collect_maybe(args), 0, None);
        ctx.defsubr("get-unicode-property-internal", |_ctx, args| builtin_get_unicode_property_internal(args), 0, None);
        ctx.defsubr("gnutls-available-p", |_ctx, args| builtin_gnutls_available_p(args), 0, None);
        ctx.defsubr("gnutls-asynchronous-parameters", |_ctx, args| builtin_gnutls_asynchronous_parameters(args), 0, None);
        ctx.defsubr("gnutls-bye", |_ctx, args| builtin_gnutls_bye(args), 0, None);
        ctx.defsubr("gnutls-ciphers", |_ctx, args| builtin_gnutls_ciphers(args), 0, None);
        ctx.defsubr("gnutls-deinit", |_ctx, args| builtin_gnutls_deinit(args), 0, None);
        ctx.defsubr("gnutls-digests", |_ctx, args| builtin_gnutls_digests(args), 0, None);
        ctx.defsubr("gnutls-error-fatalp", |_ctx, args| builtin_gnutls_error_fatalp(args), 0, None);
        ctx.defsubr("gnutls-error-string", |_ctx, args| builtin_gnutls_error_string(args), 0, None);
        ctx.defsubr("gnutls-errorp", |_ctx, args| builtin_gnutls_errorp(args), 0, None);
        ctx.defsubr("gnutls-format-certificate", |_ctx, args| builtin_gnutls_format_certificate(args), 0, None);
        ctx.defsubr("gnutls-get-initstage", |_ctx, args| builtin_gnutls_get_initstage(args), 0, None);
        ctx.defsubr("gnutls-hash-digest", |_ctx, args| builtin_gnutls_hash_digest(args), 0, None);
        ctx.defsubr("gnutls-hash-mac", |_ctx, args| builtin_gnutls_hash_mac(args), 0, None);
        ctx.defsubr("gnutls-macs", |_ctx, args| builtin_gnutls_macs(args), 0, None);
        ctx.defsubr("gnutls-peer-status", |_ctx, args| builtin_gnutls_peer_status(args), 0, None);
        ctx.defsubr("gnutls-peer-status-warning-describe", |_ctx, args| builtin_gnutls_peer_status_warning_describe(args), 0, None);
        ctx.defsubr("gnutls-symmetric-decrypt", |_ctx, args| builtin_gnutls_symmetric_decrypt(args), 0, None);
        ctx.defsubr("gnutls-symmetric-encrypt", |_ctx, args| builtin_gnutls_symmetric_encrypt(args), 0, None);
        ctx.defsubr("gpm-mouse-start", |_ctx, args| builtin_gpm_mouse_start(args), 0, None);
        ctx.defsubr("gpm-mouse-stop", |_ctx, args| builtin_gpm_mouse_stop(args), 0, None);
        ctx.defsubr("handle-save-session", |_ctx, args| builtin_handle_save_session(args), 0, None);
        ctx.defsubr("handle-switch-frame", |_ctx, args| builtin_handle_switch_frame(args), 0, None);
        ctx.defsubr("help--describe-vector", |_ctx, args| builtin_help_describe_vector(args), 0, None);
        ctx.defsubr("init-image-library", |_ctx, args| builtin_init_image_library(args), 0, None);
        ctx.defsubr("internal--obarray-buckets", |_ctx, args| builtin_internal_obarray_buckets(args), 0, None);
        ctx.defsubr("internal--set-buffer-modified-tick", |_ctx, args| builtin_internal_set_buffer_modified_tick(args), 0, None);
        ctx.defsubr("internal--track-mouse", |_ctx, args| builtin_internal_track_mouse(args), 0, None);
        ctx.defsubr("internal-char-font", |_ctx, args| builtin_internal_char_font(args), 0, None);
        ctx.defsubr("internal-complete-buffer", |_ctx, args| builtin_internal_complete_buffer(args), 0, None);
        ctx.defsubr("internal-describe-syntax-value", |_ctx, args| builtin_internal_describe_syntax_value(args), 0, None);
        ctx.defsubr("internal-event-symbol-parse-modifiers", |_ctx, args| builtin_internal_event_symbol_parse_modifiers(args), 0, None);
        ctx.defsubr("internal-handle-focus-in", |_ctx, args| builtin_internal_handle_focus_in(args), 0, None);
        ctx.defsubr("internal-set-lisp-face-attribute-from-resource", |_ctx, args| builtin_internal_set_lisp_face_attribute_from_resource(args), 0, None);
        ctx.defsubr("internal-stack-stats", |_ctx, args| builtin_internal_stack_stats(args), 0, None);
        ctx.defsubr("internal-subr-documentation", |_ctx, args| builtin_internal_subr_documentation(args), 0, None);
        ctx.defsubr("byte-code", |_ctx, args| builtin_byte_code(args), 0, None);
        ctx.defsubr("decode-coding-region", |_ctx, args| builtin_decode_coding_region(args), 0, None);
        ctx.defsubr("dump-emacs-portable", |_ctx, args| builtin_dump_emacs_portable(args), 0, None);
        ctx.defsubr("dump-emacs-portable--sort-predicate", |_ctx, args| builtin_dump_emacs_portable_sort_predicate(args), 0, None);
        ctx.defsubr("dump-emacs-portable--sort-predicate-copied", |_ctx, args| builtin_dump_emacs_portable_sort_predicate_copied(args), 0, None);
        ctx.defsubr("emacs-repository-get-version", |_ctx, args| builtin_emacs_repository_get_version(args), 0, None);
        ctx.defsubr("emacs-repository-get-branch", |_ctx, args| builtin_emacs_repository_get_branch(args), 0, None);
        ctx.defsubr("emacs-repository-get-dirty", |_ctx, args| builtin_emacs_repository_get_dirty(args), 0, None);
        ctx.defsubr("encode-coding-region", |_ctx, args| builtin_encode_coding_region(args), 0, None);
        ctx.defsubr("find-operation-coding-system", |_ctx, args| builtin_find_operation_coding_system(args), 0, None);
        ctx.defsubr("iso-charset", |_ctx, args| builtin_iso_charset(args), 0, None);
        ctx.defsubr("keymap--get-keyelt", |_ctx, args| builtin_keymap_get_keyelt(args), 0, None);
        ctx.defsubr("keymap-prompt", |_ctx, args| builtin_keymap_prompt(args), 0, None);
        ctx.defsubr("lower-frame", |_ctx, args| builtin_lower_frame(args), 0, None);
        ctx.defsubr("lread--substitute-object-in-subtree", |_ctx, args| builtin_lread_substitute_object_in_subtree(args), 0, None);
        ctx.defsubr("malloc-info", |_ctx, args| builtin_malloc_info(args), 0, None);
        ctx.defsubr("malloc-trim", |_ctx, args| builtin_malloc_trim(args), 0, None);
        ctx.defsubr("make-byte-code", |_ctx, args| builtin_make_byte_code(args), 0, None);
        ctx.defsubr("make-char", |_ctx, args| builtin_make_char(args), 0, None);
        ctx.defsubr("make-closure", |_ctx, args| builtin_make_closure(args), 0, None);
        ctx.defsubr("make-finalizer", |_ctx, args| builtin_make_finalizer(args), 0, None);
        ctx.defsubr("marker-last-position", |_ctx, args| builtin_marker_last_position(args), 0, None);
        ctx.defsubr("make-interpreted-closure", |_ctx, args| builtin_make_interpreted_closure(args), 0, None);
        ctx.defsubr("make-record", |_ctx, args| builtin_make_record(args), 0, None);
        ctx.defsubr("make-temp-file-internal", |_ctx, args| builtin_make_temp_file_internal(args), 0, None);
        ctx.defsubr("map-charset-chars", |_ctx, args| builtin_map_charset_chars(args), 0, None);
        ctx.defsubr("mapbacktrace", |_ctx, args| builtin_mapbacktrace(args), 0, None);
        ctx.defsubr("memory-info", |_ctx, args| builtin_memory_info(args), 0, None);
        ctx.defsubr("make-frame-invisible", |_ctx, args| builtin_make_frame_invisible(args), 0, None);
        ctx.defsubr("menu-bar-menu-at-x-y", |_ctx, args| builtin_menu_bar_menu_at_x_y(args), 0, None);
        ctx.defsubr("menu-or-popup-active-p", |_ctx, args| builtin_menu_or_popup_active_p(args), 0, None);
        ctx.defsubr("module-load", |_ctx, args| builtin_module_load(args), 0, None);
        ctx.defsubr("newline-cache-check", |_ctx, args| builtin_newline_cache_check(args), 0, None);
        ctx.defsubr("native-comp-available-p", |_ctx, args| builtin_native_comp_available_p(args), 0, None);
        ctx.defsubr("native-comp-unit-file", |_ctx, args| builtin_native_comp_unit_file(args), 0, None);
        ctx.defsubr("native-comp-unit-set-file", |_ctx, args| builtin_native_comp_unit_set_file(args), 0, None);
        ctx.defsubr("native-elisp-load", |_ctx, args| builtin_native_elisp_load(args), 0, None);
        ctx.defsubr("obarray-clear", |_ctx, args| builtin_obarray_clear(args), 0, None);
        ctx.defsubr("obarray-make", |_ctx, args| builtin_obarray_make(args), 0, None);
        ctx.defsubr("object-intervals", |_ctx, args| builtin_object_intervals(args), 0, None);
        ctx.defsubr("open-dribble-file", |_ctx, args| builtin_open_dribble_file(args), 0, None);
        ctx.defsubr("open-font", |_ctx, args| builtin_open_font(args), 0, None);
        ctx.defsubr("optimize-char-table", |_ctx, args| builtin_optimize_char_table(args), 0, None);
        ctx.defsubr("overlay-lists", |_ctx, args| builtin_overlay_lists(args), 0, None);
        ctx.defsubr("overlay-recenter", |_ctx, args| builtin_overlay_recenter(args), 0, None);
        ctx.defsubr("pdumper-stats", |_ctx, args| builtin_pdumper_stats(args), 0, None);
        ctx.defsubr("play-sound-internal", |_ctx, args| builtin_play_sound_internal(args), 0, None);
        ctx.defsubr("position-symbol", |_ctx, args| builtin_position_symbol(args), 0, None);
        ctx.defsubr("profiler-cpu-log", |_ctx, args| builtin_profiler_cpu_log(args), 0, None);
        ctx.defsubr("profiler-cpu-running-p", |_ctx, args| builtin_profiler_cpu_running_p(args), 0, None);
        ctx.defsubr("profiler-cpu-start", |_ctx, args| builtin_profiler_cpu_start(args), 0, None);
        ctx.defsubr("profiler-cpu-stop", |_ctx, args| builtin_profiler_cpu_stop(args), 0, None);
        ctx.defsubr("profiler-memory-log", |_ctx, args| builtin_profiler_memory_log(args), 0, None);
        ctx.defsubr("profiler-memory-running-p", |_ctx, args| builtin_profiler_memory_running_p(args), 0, None);
        ctx.defsubr("profiler-memory-start", |_ctx, args| builtin_profiler_memory_start(args), 0, None);
        ctx.defsubr("profiler-memory-stop", |_ctx, args| builtin_profiler_memory_stop(args), 0, None);
        ctx.defsubr("put-unicode-property-internal", |_ctx, args| builtin_put_unicode_property_internal(args), 0, None);
        ctx.defsubr("query-font", |_ctx, args| builtin_query_font(args), 0, None);
        ctx.defsubr("query-fontset", |_ctx, args| builtin_query_fontset(args), 0, None);
        ctx.defsubr("raise-frame", |_ctx, args| builtin_raise_frame(args), 0, None);
        ctx.defsubr("read-positioning-symbols", |_ctx, args| builtin_read_positioning_symbols(args), 0, None);
        ctx.defsubr("re--describe-compiled", |_ctx, args| builtin_re_describe_compiled(args), 0, None);
        ctx.defsubr("recent-auto-save-p", |_ctx, args| builtin_recent_auto_save_p(args), 0, None);
        ...
        ctx.defsubr("reconsider-frame-fonts", |_ctx, args| builtin_reconsider_frame_fonts(args), 0, None);
        ctx.defsubr("redirect-debugging-output", |_ctx, args| builtin_redirect_debugging_output(args), 0, None);
        ctx.defsubr("redirect-frame-focus", |_ctx, args| builtin_redirect_frame_focus(args), 0, None);
        ctx.defsubr("remove-pos-from-symbol", |_ctx, args| builtin_remove_pos_from_symbol(args), 0, None);
        ctx.defsubr("resize-mini-window-internal", |_ctx, args| builtin_resize_mini_window_internal(args), 0, None);
        ctx.defsubr("restore-buffer-modified-p", |_ctx, args| builtin_restore_buffer_modified_p(args), 0, None);
        ctx.defsubr("set--this-command-keys", |_ctx, args| builtin_set_this_command_keys(args), 0, None);
        ctx.defsubr("set-buffer-auto-saved", |_ctx, args| builtin_set_buffer_auto_saved(args), 0, None);
        ctx.defsubr("set-buffer-major-mode", |_ctx, args| builtin_set_buffer_major_mode(args), 0, None);
        ctx.defsubr("set-buffer-redisplay", |_ctx, args| builtin_set_buffer_redisplay(args), 0, None);
        ctx.defsubr("set-charset-plist", |_ctx, args| builtin_set_charset_plist(args), 0, None);
        ctx.defsubr("set-frame-window-state-change", |_ctx, args| builtin_set_frame_window_state_change(args), 0, None);
        ctx.defsubr("set-fringe-bitmap-face", |_ctx, args| builtin_set_fringe_bitmap_face(args), 0, None);
        ctx.defsubr("set-minibuffer-window", |_ctx, args| builtin_set_minibuffer_window(args), 0, None);
        ctx.defsubr("set-mouse-pixel-position", |_ctx, args| builtin_set_mouse_pixel_position(args), 0, None);
        ctx.defsubr("set-mouse-position", |_ctx, args| builtin_set_mouse_position(args), 0, None);
        ctx.defsubr("set-window-new-normal", |_ctx, args| builtin_set_window_new_normal(args), 0, None);
        ctx.defsubr("set-window-new-pixel", |_ctx, args| builtin_set_window_new_pixel(args), 0, None);
        ctx.defsubr("set-window-new-total", |_ctx, args| builtin_set_window_new_total(args), 0, None);
        ctx.defsubr("sort-charsets", |_ctx, args| builtin_sort_charsets(args), 0, None);
        ctx.defsubr("split-char", |_ctx, args| builtin_split_char(args), 0, None);
        ctx.defsubr("string-distance", |_ctx, args| builtin_string_distance(args), 0, None);
        ctx.defsubr("subr-native-comp-unit", |_ctx, args| builtin_subr_native_comp_unit(args), 0, None);
        ctx.defsubr("subr-native-lambda-list", |_ctx, args| builtin_subr_native_lambda_list(args), 0, None);
        ctx.defsubr("subr-type", |_ctx, args| builtin_subr_type(args), 0, None);
        ctx.defsubr("suspend-emacs", |_ctx, args| builtin_suspend_emacs(args), 0, None);
        ctx.defsubr("thread--blocker", |_ctx, args| builtin_thread_blocker(args), 0, None);
        ctx.defsubr("tool-bar-get-system-style", |_ctx, args| builtin_tool_bar_get_system_style(args), 0, None);
        ctx.defsubr("tool-bar-pixel-width", |_ctx, args| builtin_tool_bar_pixel_width(args), 0, None);
        ctx.defsubr("translate-region-internal", |_ctx, args| builtin_translate_region_internal(args), 0, None);
        ctx.defsubr("transpose-regions", |_ctx, args| builtin_transpose_regions(args), 0, None);
        ctx.defsubr("tty--output-buffer-size", |_ctx, args| builtin_tty_output_buffer_size(args), 0, None);
        ctx.defsubr("tty--set-output-buffer-size", |_ctx, args| builtin_tty_set_output_buffer_size(args), 0, None);
        ctx.defsubr("tty-display-pixel-height", |_ctx, args| builtin_tty_display_pixel_height(args), 0, None);
        ctx.defsubr("tty-display-pixel-width", |_ctx, args| builtin_tty_display_pixel_width(args), 0, None);
        ctx.defsubr("tty-frame-at", |_ctx, args| builtin_tty_frame_at(args), 0, None);
        ctx.defsubr("tty-frame-edges", |_ctx, args| builtin_tty_frame_edges(args), 0, None);
        ctx.defsubr("tty-frame-geometry", |_ctx, args| builtin_tty_frame_geometry(args), 0, None);
        ctx.defsubr("tty-frame-list-z-order", |_ctx, args| builtin_tty_frame_list_z_order(args), 0, None);
        ctx.defsubr("tty-frame-restack", |_ctx, args| builtin_tty_frame_restack(args), 0, None);
        ctx.defsubr("tty-suppress-bold-inverse-default-colors", |_ctx, args| builtin_tty_suppress_bold_inverse_default_colors(args), 0, None);
        ctx.defsubr("unencodable-char-position", |_ctx, args| builtin_unencodable_char_position(args), 0, None);
        ctx.defsubr("unicode-property-table-internal", |_ctx, args| builtin_unicode_property_table_internal(args), 0, None);
        ctx.defsubr("unify-charset", |_ctx, args| builtin_unify_charset(args), 0, None);
        ctx.defsubr("unix-sync", |_ctx, args| builtin_unix_sync(args), 0, None);
        ctx.defsubr("value<", |_ctx, args| builtin_value_lt(args), 0, None);
        ctx.defsubr("x-begin-drag", |_ctx, args| builtin_x_begin_drag(args), 0, None);
        ctx.defsubr("x-double-buffered-p", |_ctx, args| builtin_x_double_buffered_p(args), 0, None);
        ctx.defsubr("x-menu-bar-open-internal", |_ctx, args| builtin_x_menu_bar_open_internal(args), 0, None);
        ctx.defsubr("xw-color-defined-p", |_ctx, args| builtin_xw_color_defined_p(args), 0, None);
        ctx.defsubr("xw-color-values", |_ctx, args| builtin_xw_color_values(args), 0, None);
        ctx.defsubr("xw-display-color-p", |_ctx, args| builtin_xw_display_color_p(args), 0, None);
        ctx.defsubr("inotify-add-watch", |_ctx, args| builtin_inotify_add_watch(args), 0, None);
        ctx.defsubr("inotify-allocated-p", |_ctx, args| builtin_inotify_allocated_p(args), 0, None);
        ctx.defsubr("inotify-rm-watch", |_ctx, args| builtin_inotify_rm_watch(args), 0, None);
        ctx.defsubr("inotify-valid-p", |_ctx, args| builtin_inotify_valid_p(args), 0, None);
        ctx.defsubr("inotify-watch-list", |_ctx, args| builtin_inotify_watch_list(args), 0, None);
        ctx.defsubr("lock-buffer", |_ctx, args| builtin_lock_buffer(args), 0, None);
        ctx.defsubr("lock-file", |_ctx, args| builtin_lock_file(args), 0, None);
        ctx.defsubr("lossage-size", |_ctx, args| builtin_lossage_size(args), 0, None);
        ctx.defsubr("unlock-buffer", |_ctx, args| builtin_unlock_buffer(args), 0, None);
        ctx.defsubr("unlock-file", |_ctx, args| builtin_unlock_file(args), 0, None);
        ctx.defsubr("window-bottom-divider-width", |_ctx, args| builtin_window_bottom_divider_width(args), 0, None);
        ctx.defsubr("window-lines-pixel-dimensions", |_ctx, args| builtin_window_lines_pixel_dimensions(args), 0, None);
        ctx.defsubr("window-new-normal", |_ctx, args| builtin_window_new_normal(args), 0, None);
        ctx.defsubr("window-new-pixel", |_ctx, args| builtin_window_new_pixel(args), 0, None);
        ctx.defsubr("window-new-total", |_ctx, args| builtin_window_new_total(args), 0, None);
        ctx.defsubr("window-old-body-pixel-height", |_ctx, args| builtin_window_old_body_pixel_height(args), 0, None);
        ctx.defsubr("window-old-body-pixel-width", |_ctx, args| builtin_window_old_body_pixel_width(args), 0, None);
        ctx.defsubr("window-old-pixel-height", |_ctx, args| builtin_window_old_pixel_height(args), 0, None);
        ctx.defsubr("window-old-pixel-width", |_ctx, args| builtin_window_old_pixel_width(args), 0, None);
        ctx.defsubr("window-right-divider-width", |_ctx, args| builtin_window_right_divider_width(args), 0, None);
        ctx.defsubr("window-scroll-bar-height", |_ctx, args| builtin_window_scroll_bar_height(args), 0, None);
        ctx.defsubr("window-scroll-bar-width", |_ctx, args| builtin_window_scroll_bar_width(args), 0, None);
        ctx.defsubr("treesit-available-p", |_ctx, args| builtin_treesit_available_p(args), 0, None);
        ctx.defsubr("treesit-compiled-query-p", |_ctx, args| builtin_treesit_compiled_query_p(args), 0, None);
        ctx.defsubr("treesit-induce-sparse-tree", |_ctx, args| builtin_treesit_induce_sparse_tree(args), 0, None);
        ctx.defsubr("treesit-language-abi-version", |_ctx, args| builtin_treesit_language_abi_version(args), 0, None);
        ctx.defsubr("treesit-language-available-p", |_ctx, args| builtin_treesit_language_available_p(args), 0, None);
        ctx.defsubr("treesit-library-abi-version", |_ctx, args| builtin_treesit_library_abi_version(args), 0, None);
        ctx.defsubr("treesit-node-check", |_ctx, args| builtin_treesit_node_check(args), 0, None);
        ctx.defsubr("treesit-node-child", |_ctx, args| builtin_treesit_node_child(args), 0, None);
        ctx.defsubr("treesit-node-child-by-field-name", |_ctx, args| builtin_treesit_node_child_by_field_name(args), 0, None);
        ctx.defsubr("treesit-node-child-count", |_ctx, args| builtin_treesit_node_child_count(args), 0, None);
        ctx.defsubr("treesit-node-descendant-for-range", |_ctx, args| builtin_treesit_node_descendant_for_range(args), 0, None);
        ctx.defsubr("treesit-node-end", |_ctx, args| builtin_treesit_node_end(args), 0, None);
        ctx.defsubr("treesit-node-eq", |_ctx, args| builtin_treesit_node_eq(args), 0, None);
        ctx.defsubr("treesit-node-field-name-for-child", |_ctx, args| builtin_treesit_node_field_name_for_child(args), 0, None);
        ctx.defsubr("treesit-node-first-child-for-pos", |_ctx, args| builtin_treesit_node_first_child_for_pos(args), 0, None);
        ctx.defsubr("treesit-node-match-p", |_ctx, args| builtin_treesit_node_match_p(args), 0, None);
        ctx.defsubr("treesit-node-next-sibling", |_ctx, args| builtin_treesit_node_next_sibling(args), 0, None);
        ctx.defsubr("treesit-node-p", |_ctx, args| builtin_treesit_node_p(args), 0, None);
        ctx.defsubr("treesit-node-parent", |_ctx, args| builtin_treesit_node_parent(args), 0, None);
        ctx.defsubr("treesit-node-parser", |_ctx, args| builtin_treesit_node_parser(args), 0, None);
        ctx.defsubr("treesit-node-prev-sibling", |_ctx, args| builtin_treesit_node_prev_sibling(args), 0, None);
        ctx.defsubr("treesit-node-start", |_ctx, args| builtin_treesit_node_start(args), 0, None);
        ctx.defsubr("treesit-node-string", |_ctx, args| builtin_treesit_node_string(args), 0, None);
        ctx.defsubr("treesit-node-type", |_ctx, args| builtin_treesit_node_type(args), 0, None);
        ctx.defsubr("treesit-parser-add-notifier", |_ctx, args| builtin_treesit_parser_add_notifier(args), 0, None);
        ctx.defsubr("treesit-parser-buffer", |_ctx, args| builtin_treesit_parser_buffer(args), 0, None);
        ctx.defsubr("treesit-parser-create", |_ctx, args| builtin_treesit_parser_create(args), 0, None);
        ctx.defsubr("treesit-parser-delete", |_ctx, args| builtin_treesit_parser_delete(args), 0, None);
        ctx.defsubr("treesit-parser-included-ranges", |_ctx, args| builtin_treesit_parser_included_ranges(args), 0, None);
        ctx.defsubr("treesit-parser-language", |_ctx, args| builtin_treesit_parser_language(args), 0, None);
        ctx.defsubr("treesit-parser-list", |_ctx, args| builtin_treesit_parser_list(args), 0, None);
        ctx.defsubr("treesit-parser-notifiers", |_ctx, args| builtin_treesit_parser_notifiers(args), 0, None);
        ctx.defsubr("treesit-parser-p", |_ctx, args| builtin_treesit_parser_p(args), 0, None);
        ctx.defsubr("treesit-parser-remove-notifier", |_ctx, args| builtin_treesit_parser_remove_notifier(args), 0, None);
        ctx.defsubr("treesit-parser-root-node", |_ctx, args| builtin_treesit_parser_root_node(args), 0, None);
        ctx.defsubr("treesit-parser-set-included-ranges", |_ctx, args| builtin_treesit_parser_set_included_ranges(args), 0, None);
        ctx.defsubr("treesit-parser-tag", |_ctx, args| builtin_treesit_parser_tag(args), 0, None);
        ctx.defsubr("treesit-pattern-expand", |_ctx, args| builtin_treesit_pattern_expand(args), 0, None);
        ctx.defsubr("treesit-query-capture", |_ctx, args| builtin_treesit_query_capture(args), 0, None);
        ctx.defsubr("treesit-query-compile", |_ctx, args| builtin_treesit_query_compile(args), 0, None);
        ctx.defsubr("treesit-query-expand", |_ctx, args| builtin_treesit_query_expand(args), 0, None);
        ctx.defsubr("treesit-query-language", |_ctx, args| builtin_treesit_query_language(args), 0, None);
        ctx.defsubr("treesit-query-p", |_ctx, args| builtin_treesit_query_p(args), 0, None);
        ctx.defsubr("treesit-search-forward", |_ctx, args| builtin_treesit_search_forward(args), 0, None);
        ctx.defsubr("treesit-search-subtree", |_ctx, args| builtin_treesit_search_subtree(args), 0, None);
        ctx.defsubr("treesit-subtree-stat", |_ctx, args| builtin_treesit_subtree_stat(args), 0, None);
        ctx.defsubr("treesit-grammar-location", |_ctx, args| builtin_treesit_grammar_location(args), 0, None);
        ctx.defsubr("treesit-tracking-line-column-p", |_ctx, args| builtin_treesit_tracking_line_column_p(args), 0, None);
        ctx.defsubr("treesit-parser-tracking-line-column-p", |_ctx, args| builtin_treesit_parser_tracking_line_column_p(args), 0, None);
        ctx.defsubr("treesit-query-eagerly-compiled-p", |_ctx, args| builtin_treesit_query_eagerly_compiled_p(args), 0, None);
        ctx.defsubr("treesit-query-source", |_ctx, args| builtin_treesit_query_source(args), 0, None);
        ctx.defsubr("treesit-parser-embed-level", |_ctx, args| builtin_treesit_parser_embed_level(args), 0, None);
        ctx.defsubr("treesit-parser-set-embed-level", |_ctx, args| builtin_treesit_parser_set_embed_level(args), 0, None);
        ctx.defsubr("treesit-parse-string", |_ctx, args| builtin_treesit_parse_string(args), 0, None);
        ctx.defsubr("treesit-parser-changed-regions", |_ctx, args| builtin_treesit_parser_changed_regions(args), 0, None);
        ctx.defsubr("treesit--linecol-at", |_ctx, args| builtin_treesit_linecol_at(args), 0, None);
        ctx.defsubr("treesit--linecol-cache-set", |_ctx, args| builtin_treesit_linecol_cache_set(args), 0, None);
        ctx.defsubr("treesit--linecol-cache", |_ctx, args| builtin_treesit_linecol_cache(args), 0, None);
        ctx.defsubr("sqlite-available-p", |_ctx, args| builtin_sqlite_available_p(args), 0, None);
        ctx.defsubr("sqlite-close", |_ctx, args| builtin_sqlite_close(args), 0, None);
        ctx.defsubr("sqlite-columns", |_ctx, args| builtin_sqlite_columns(args), 0, None);
        ctx.defsubr("sqlite-commit", |_ctx, args| builtin_sqlite_commit(args), 0, None);
        ctx.defsubr("sqlite-execute", |_ctx, args| builtin_sqlite_execute(args), 0, None);
        ctx.defsubr("sqlite-execute-batch", |_ctx, args| builtin_sqlite_execute_batch(args), 0, None);
        ctx.defsubr("sqlite-finalize", |_ctx, args| builtin_sqlite_finalize(args), 0, None);
        ctx.defsubr("sqlite-load-extension", |_ctx, args| builtin_sqlite_load_extension(args), 0, None);
        ctx.defsubr("sqlite-more-p", |_ctx, args| builtin_sqlite_more_p(args), 0, None);
        ctx.defsubr("sqlite-next", |_ctx, args| builtin_sqlite_next(args), 0, None);
        ctx.defsubr("sqlite-open", |_ctx, args| builtin_sqlite_open(args), 0, None);
        ctx.defsubr("sqlite-pragma", |_ctx, args| builtin_sqlite_pragma(args), 0, None);
        ctx.defsubr("sqlite-rollback", |_ctx, args| builtin_sqlite_rollback(args), 0, None);
        ctx.defsubr("sqlite-select", |_ctx, args| builtin_sqlite_select(args), 0, None);
        ctx.defsubr("sqlite-transaction", |_ctx, args| builtin_sqlite_transaction(args), 0, None);
        ctx.defsubr("sqlite-version", |_ctx, args| builtin_sqlite_version(args), 0, None);
        ctx.defsubr("sqlitep", |_ctx, args| builtin_sqlitep(args), 0, None);
        ctx.defsubr("fillarray", |_ctx, args| builtin_fillarray(args), 0, None);
        ctx.defsubr("define-hash-table-test", |_ctx, args| builtin_define_hash_table_test(args), 0, None);
        ctx.defsubr("hash-table-test", |_ctx, args| super::hashtab::builtin_hash_table_test(args), 0, None);
        ctx.defsubr("hash-table-size", |_ctx, args| super::hashtab::builtin_hash_table_size(args), 0, None);
        ctx.defsubr("hash-table-rehash-size", |_ctx, args| super::hashtab::builtin_hash_table_rehash_size(args), 0, None);
        ctx.defsubr("hash-table-rehash-threshold", |_ctx, args| super::hashtab::builtin_hash_table_rehash_threshold(args), 0, None);
        ctx.defsubr("hash-table-weakness", |_ctx, args| super::hashtab::builtin_hash_table_weakness(args), 0, None);
        ctx.defsubr("copy-hash-table", |_ctx, args| super::hashtab::builtin_copy_hash_table(args), 0, None);
        ctx.defsubr("sxhash-eq", |_ctx, args| super::hashtab::builtin_sxhash_eq(args), 0, None);
        ctx.defsubr("sxhash-eql", |_ctx, args| super::hashtab::builtin_sxhash_eql(args), 0, None);
        ctx.defsubr("sxhash-equal", |_ctx, args| super::hashtab::builtin_sxhash_equal(args), 0, None);
        ctx.defsubr("sxhash-equal-including-properties", |_ctx, args| super::hashtab::builtin_sxhash_equal_including_properties(args), 0, None);
        ctx.defsubr("internal--hash-table-buckets", |_ctx, args| super::hashtab::builtin_internal_hash_table_buckets(args), 0, None);
        ctx.defsubr("internal--hash-table-histogram", |_ctx, args| super::hashtab::builtin_internal_hash_table_histogram(args), 0, None);
        ctx.defsubr("internal--hash-table-index-size", |_ctx, args| super::hashtab::builtin_internal_hash_table_index_size(args), 0, None);
        ctx.defsubr("debug-timer-check", |_ctx, args| builtin_debug_timer_check(args), 0, None);
        ctx.defsubr("dbus-close-inhibitor-lock", |_ctx, args| builtin_dbus_close_inhibitor_lock(args), 0, None);
        ctx.defsubr("dbus-make-inhibitor-lock", |_ctx, args| builtin_dbus_make_inhibitor_lock(args), 0, None);
        ctx.defsubr("dbus-registered-inhibitor-locks", |_ctx, args| builtin_dbus_registered_inhibitor_locks(args), 0, None);
        ctx.defsubr("lcms2-available-p", |_ctx, args| builtin_lcms2_available_p(args), 0, None);
        ctx.defsubr("lcms-cie-de2000", |_ctx, args| builtin_lcms_cie_de2000(args), 0, None);
        ctx.defsubr("lcms-xyz->jch", |_ctx, args| builtin_lcms_xyz_to_jch(args), 0, None);
        ctx.defsubr("lcms-jch->xyz", |_ctx, args| builtin_lcms_jch_to_xyz(args), 0, None);
        ctx.defsubr("lcms-jch->jab", |_ctx, args| builtin_lcms_jch_to_jab(args), 0, None);
        ctx.defsubr("lcms-jab->jch", |_ctx, args| builtin_lcms_jab_to_jch(args), 0, None);
        ctx.defsubr("lcms-cam02-ucs", |_ctx, args| builtin_lcms_cam02_ucs(args), 0, None);
        ctx.defsubr("lcms-temp->white-point", |_ctx, args| builtin_lcms_temp_to_white_point(args), 0, None);
        ctx.defsubr("neomacs-frame-geometry", |_ctx, args| builtin_neomacs_frame_geometry(args), 0, None);
        ctx.defsubr("neomacs-frame-edges", |_ctx, args| builtin_neomacs_frame_edges(args), 0, None);
        ctx.defsubr("neomacs-mouse-absolute-pixel-position", |_ctx, args| builtin_neomacs_mouse_absolute_pixel_position(args), 0, None);
        ctx.defsubr("neomacs-set-mouse-absolute-pixel-position", |_ctx, args| builtin_neomacs_set_mouse_absolute_pixel_position(args), 0, None);
        ctx.defsubr("neomacs-display-monitor-attributes-list", |_ctx, args| builtin_neomacs_display_monitor_attributes_list(args), 0, None);
        ctx.defsubr("x-scroll-bar-foreground", |_ctx, args| builtin_x_scroll_bar_foreground(args), 0, None);
        ctx.defsubr("x-scroll-bar-background", |_ctx, args| builtin_x_scroll_bar_background(args), 0, None);
        ctx.defsubr("neomacs-clipboard-set", |_ctx, args| builtin_neomacs_clipboard_set(args), 0, None);
        ctx.defsubr("neomacs-clipboard-get", |_ctx, args| builtin_neomacs_clipboard_get(args), 0, None);
        ctx.defsubr("neomacs-primary-selection-set", |_ctx, args| builtin_neomacs_primary_selection_set(args), 0, None);
        ctx.defsubr("neomacs-primary-selection-get", |_ctx, args| builtin_neomacs_primary_selection_get(args), 0, None);
        ctx.defsubr("neomacs-core-backend", |_ctx, args| builtin_neomacs_core_backend(args), 0, None);
        ctx.defsubr("buffer-local-toplevel-value", |_ctx, args| builtin_buffer_local_toplevel_value(args), 0, None);
        ctx.defsubr("set-buffer-local-toplevel-value", |_ctx, args| builtin_set_buffer_local_toplevel_value(args), 0, None);
        ctx.defsubr("debugger-trap", |_ctx, args| builtin_debugger_trap(args), 0, None);
        ctx.defsubr("internal-delete-indirect-variable", |_ctx, args| builtin_internal_delete_indirect_variable(args), 0, None);
        ctx.defsubr("internal-decode-string-utf-8", |_ctx, args| builtin_internal_decode_string_utf_8(args), 0, None);
        ctx.defsubr("internal-encode-string-utf-8", |_ctx, args| builtin_internal_encode_string_utf_8(args), 0, None);
        ctx.defsubr("overlay-tree", |_ctx, args| builtin_overlay_tree(args), 0, None);
        ctx.defsubr("thread-buffer-disposition", |_ctx, args| builtin_thread_buffer_disposition(args), 0, None);
        ctx.defsubr("thread-set-buffer-disposition", |_ctx, args| builtin_thread_set_buffer_disposition(args), 0, None);
        ctx.defsubr("window-discard-buffer-from-window", |_ctx, args| builtin_window_discard_buffer_from_window(args), 0, None);
        ctx.defsubr("window-cursor-info", |_ctx, args| builtin_window_cursor_info(args), 0, None);
        ctx.defsubr("combine-windows", |_ctx, args| builtin_combine_windows(args), 0, None);
        ctx.defsubr("uncombine-window", |_ctx, args| builtin_uncombine_window(args), 0, None);
        ctx.defsubr("frame-windows-min-size", |_ctx, args| builtin_frame_windows_min_size(args), 0, None);
        ctx.defsubr("remember-mouse-glyph", |_ctx, args| builtin_remember_mouse_glyph(args), 0, None);
        ctx.defsubr("lookup-image", |_ctx, args| builtin_lookup_image(args), 0, None);
        ctx.defsubr("imagemagick-types", |_ctx, args| builtin_imagemagick_types(args), 0, None);
        ctx.defsubr("font-drive-otf", |_ctx, args| builtin_font_drive_otf(args), 0, None);
        ctx.defsubr("font-otf-alternates", |_ctx, args| builtin_font_otf_alternates(args), 0, None);
